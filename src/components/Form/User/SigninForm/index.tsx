/**
 * @file This file contains the LoginForm component, which is a form for user login.
 * @module LoginForm
 */
"use client";
...
/**
 * Initial form values for the LoginForm component.
...
/**
 * The LoginForm functional component.
 * @component
